...
{
    class LargeSizeButtonViewModel : TopMenuButtonViewModel
    {

       //Calls the constructor of TopMenuButtonViewModel
        public LargeSizeButtonViewModel(Bitmap image)
            : base(image)
        { }
 


        //Click event for large size button
        public override void ClickExecuted()
        {
            ...
            string query = "insert into Ordered_items(Item_name,Item_image,Item_size) select Item_name, Item_image,'Large' from Selected_items where Id=(select max(Id) from Selected_items)";
